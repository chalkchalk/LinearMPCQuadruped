...
RealDog::RealDog(ros::NodeHandle &nh) : nh_(nh), udp_comm_(SAFE_POWER_LEVEL), info_to_ros_(nh)
{
    ...
    udp_received_ = false;
    quadruped_cmd_sub_ = nh_.subscribe("/quadruped_cmd", 100, &RealDog::quadruped_cmd_callback, this);
...
void RealDog::quadruped_cmd_callback(const quadruped_msgs::QuadrupedMove &msg)
{
