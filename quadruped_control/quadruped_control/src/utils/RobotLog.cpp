...
RobotLog::RobotLog(std::string file_path)
{
    data_header_loaded_ = false;
    tick_ = 0;
    log_file_ = file_path + Utils::getCurrentTimeAsString() + ".log";
    // log_file_ = "/root/A1_ctrl_ws/src/dog_ctrl/quadruped_control/logs/" + Utils::getCurrentTimeAsString() + ".txt";
